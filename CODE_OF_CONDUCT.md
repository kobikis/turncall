...
We pledge to make participation in TurnCall a harassment-free experience for
...
Report unacceptable behavior by contacting the maintainer privately through
GitHub — either by [opening a private security
advisory](https://github.com/kobikis/turncall/security/advisories/new), which
is a private channel visible only to maintainers, or by direct message to
[@kobikis](https://github.com/kobikis). Reports involving a maintainer can also
be escalated to [GitHub Support](https://support.github.com/contact/report-abuse).
