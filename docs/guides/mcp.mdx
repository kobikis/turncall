...
<Tip>
  For Slack and Google Calendar specifically, the [Agent Builder](/guides/agent-builder)
  can handle the authorization for you and run an action after a call ends — see
  [Connected apps](/guides/integrations). Everything below is the manual path,
  and stays the escape hatch for anything else.
</Tip>
...
| `MCP_CONNECT_TIMEOUT_SECONDS` | `10` | Connecting and discovering, all servers together |
