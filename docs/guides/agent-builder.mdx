...
<Note>
  To let it act in your Slack or your Google Calendar, connect the app once for
  the workspace and choose when it runs on the agent's Configuration tab. See
  [Connected apps](/guides/integrations).
</Note>
